...
checkClientSecurity = function (options) {
  ...
  if (options.firebaseConfig) {
    throw new Error('Push.init: Dont add your firebaseConfig in client code!');
  }
};
...
badgeNumberFunction = function() {
  return 1;
};

PushOverrides = {
  setBadgeFunction: function(func) {
    badgeNumberFunction = func;
  }
};
